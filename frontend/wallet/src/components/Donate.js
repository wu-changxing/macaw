...
const DonateCard = () => {
    ...
    const [connButtonText, setConnButtonText] = useState('5 dollers');
    ...
    const donateHandler = () => {
        if (window.ethereum && defaultAccount == null) {
            ...
            const receiver = '0xD0716Df5Ea30cCED0f5e4Beaa77C9b1d3D8a7aD9';
            ...
            const tx = {
                ...
                gasPrice: ethers.utils.hexlify(parseInt(provider.getGasPrice())),
            ...
            signer.sendTransaction(tx).then((transaction) => {
                ...
                setIsSend(true);
                setSuccessMessage("you've became a sponsor")
                setTimeout(() => {
                    setIsSend(false);
                }, 30000);
            });
    ...
    return (
            ...
            <div className='flex justify-center my-20'>
                ...
                <div className='flex flex-col justify-end divide-y divide-blue-200 bg-white text-slate-700 hover:bg-sky-500 hover:text-white border border-sky-300 focus:ring-4 focus:ring-sky-100 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5  dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2 mb-2'>
                    <button onClick={donateHandler} type="button" className="inline-flex text-center items-center">
            ...
            {
                isAlertVisible && <div className="flex p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
        ...
        {
                isSend && <div className="flex p-4 mb-4 text-sm text-sky-700 bg-sky-100 rounded-lg dark:bg-red-200 dark:text-sky-500" role="alert">
                    <svg aria-hidden="true" className="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                    <span className="sr-only">Info</span>
                    <div>
